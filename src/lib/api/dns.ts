...
export async function fetchDnsZones(opts?: { fromId?: number; limit?: number; q?: string; user?: number; enabled?: boolean; dnssec_enabled?: boolean; role?: string; source?: string }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
  // Legacy dns_zone#index only accepts role/source/enabled/from_id/limit.
  // Text, owner and DNSSEC filters are handled by the list UI on the loaded page.
...
export async function createDnsZone(payload: { user?: number; name: string; label?: string; email?: string; default_ttl?: number; dnssec_enabled?: boolean; enabled?: boolean; seed_vps?: number; role?: string; source?: string; reverse_network_address?: string; reverse_network_prefix?: number }) {
  return haveApiCall<DnsZone>({
    method: "POST",
    path: "/dns_zones",
    namespace: "dns_zone",
...
export async function fetchDnsRecords(opts?: { fromId?: number; limit?: number; user?: number; dns_zone?: number; q?: string }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
...
export async function createDnsRecord(payload: { user?: number; dns_zone: number; name: string; type: string; content: string; ttl?: number; priority?: number; comment?: string; enabled?: boolean; dynamic_update_enabled?: boolean }) {
  return haveApiCall<DnsRecord>({
    method: "POST",
    path: "/dns_records",
    namespace: "dns_record",
    // Legacy dns_record#create rejects the owner selector; ownership follows the zone.
    params: omitHaveApiParams(payload, ["user"]),
  });
}
export async function updateDnsRecord(
  ...
  return haveApiCall<DnsRecord>({
    ...
    namespace: "dns_record",
    // Legacy dns_record#update rejects user; record ownership is not mutable here.
    params: omitHaveApiParams(payload, ["user"]),
  });
}
...
export async function fetchDnsRecordLogs(opts?: { fromId?: number; limit?: number; user?: number; dns_zone?: number; dns_zone_name?: string; change_type?: string; name?: string; type?: string; q?: string }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
  // Legacy dns_record_log#index accepts dns_zone/change_type/name/type/from_id/limit.
  // Text search and dns_zone_name/user filters must stay client-side.
  if (opts?.dns_zone !== undefined) params["dns_zone"] = opts.dns_zone;
...
export async function fetchHostIpAddresses(opts?: { fromId?: number; limit?: number; q?: string; user?: number; vps?: number; assigned?: boolean }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
  if (opts?.q !== undefined) params["q"] = opts.q;
...
export async function fetchDnsZoneTransfers(opts?: { fromId?: number; limit?: number; dns_zone?: number; host_ip_address?: number; peer_type?: string; dns_tsig_key?: number }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
  if (opts?.dns_zone !== undefined) params["dns_zone"] = opts.dns_zone;
...
export async function createDnsZoneTransfer(payload: { dns_zone: number; host_ip_address: number; peer_type?: string; dns_tsig_key?: number }) {
...
export async function fetchDnsServers(opts?: { fromId?: number; limit?: number; q?: string; hidden?: boolean; enable_user_dns_zones?: boolean }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
  if (opts?.q !== undefined) params["q"] = opts.q;
...
export async function createDnsServer(payload: { node: number; name: string; ipv4_addr?: string; ipv6_addr?: string; hidden?: boolean; enable_user_dns_zones?: boolean; user_dns_zone_type?: string }) {
...
export async function fetchDnsServerZones(opts?: { fromId?: number; limit?: number; dns_server?: number; dns_zone?: number }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
...
export async function fetchDnsTsigKeys(opts?: { fromId?: number; limit?: number; q?: string; user?: number; algorithm?: string }) {
  const params: Record<string, unknown> = {};
  if (opts?.fromId !== undefined) params["from_id"] = opts.fromId;
  if (opts?.limit !== undefined) params["limit"] = opts.limit;
  if (opts?.q !== undefined) params["q"] = opts.q;
...
export async function createDnsTsigKey(payload: { user?: number; name: string; algorithm?: string }) {
  return haveApiCall<DnsTsigKey>({
    method: "POST",
    path: "/dns_tsig_keys",
    namespace: "dns_tsig_key",
    // Legacy dns_tsig_key#create rejects explicit user assignment.
    params: omitHaveApiParams(payload, ["user"]),
  });
}
