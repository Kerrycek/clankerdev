...
export const enStorage = {
  ...
  'datasets.client_filter_note': 'Owner filters are applied only to the currently loaded page; search/VPS filters and pagination still use legacy API filters.',
  ...
  'dataset.manage.delete.description': 'Delete {dataset} and all its descendants and snapshots? This cannot be undone.',
  'dataset.manage.delete.error': 'Dataset deletion failed',
  'dataset.manage.validation.title': 'Check dataset properties',
  'dataset.manage.validation.properties': 'Use non-negative GiB values and a record size between 4 and 128 KiB.',
  ...
  'dataset.snapshots.create.help': 'Creates a point-in-time snapshot of this dataset and starts a trackable backend action when the API returns one.',
  'dataset.snapshots.create.scope': 'Target dataset: {dataset}. The new snapshot appears in this list after the action starts.',
  ...
  'dataset.snapshots.confirm.rollback.body': 'This rolls the target dataset back to {snapshot}. Data written after that snapshot can be lost.',
  'dataset.snapshots.confirm.delete.title': 'Delete snapshot?',
  'dataset.snapshots.confirm.delete.body': 'This permanently deletes {snapshot}. Existing download links based on it may stop working.',
  ...
  'dataset.download.scope': 'Target dataset: {dataset}. The generated link appears on the Downloads tab with readiness and expiration details.',
  ...
  'dataset.downloads.create.help': 'Select a snapshot and choose a format. The API creates a temporary link as a trackable backend action when supported.',
  'dataset.downloads.create.scope': 'Target dataset: {dataset}. Ready links show their URL, checksum, size and expiration when the API exposes them.',
  ...
  'exports.client_filter_note': 'Search, state, dataset and owner filters are applied only to the currently loaded page; pagination still uses the legacy exports API.',
