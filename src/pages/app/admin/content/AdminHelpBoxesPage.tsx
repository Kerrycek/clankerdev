...
export function AdminHelpBoxesPage() {
  ...
  const rows = useMemo(() => {
    ...
    if (!term) return base;
    return base.filter((b) => String(b.content ?? '').toLowerCase().includes(term));
        ...
        <div className="grid gap-3 md:grid-cols-4">
          <div>
            ...
            <Input
              ...
              placeholder={t('admin.help_boxes.filter.page_placeholder')}
              testId="admin.help_boxes.filter.page"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              placeholder={t('admin.help_boxes.filter.action_placeholder')}
              testId="admin.help_boxes.filter.action"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              placeholder={t('admin.help_boxes.filter.search_placeholder')}
              testId="admin.help_boxes.filter.search"
            />
          </div>
        </div>
      ...
      >
        {previewTarget ? (
          <div className="space-y-3">
            ...
            <SandboxedHtml
              html={String(previewTarget.content ?? '')}
              testId="admin.help_boxes.preview.iframe"
              autoHeight
              maxAutoHeight={448}
              variant="helpBox"
        ...
        footer={
          <div className="flex items-center justify-end gap-2">
            ...
            <Button
              ...
              testId="admin.help_boxes.editor.save"
            >
              {t('common.save')}
            </Button>
          </div>
