      ...
      'GET security_advisories': () => ({
        security_advisories: [
          ...
          },
          {
            ...
            affected_vps_count: 21,
            en_summary: 'Review running kernels and schedule the maintenance update.',
            cs_summary: 'Zkontrolujte běžící kernely a naplánujte servisní aktualizaci.',
            security_advisory_cves: [
              { id: 7801, cve_id: 'CVE-2026-0042' },
              { id: 7802, cve_id: 'CVE-2026-0043' },
            ],
          },
        ],
        _meta: { total_count: 2 },
